      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              href="/na-mieru"
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-[15px] font-semibold transition-colors"
            >
              Projekt na mieru
            </Link>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden py-4 border-t border-white/10">
            <div className="flex flex-col space-y-4">
              ...
              <Link
                href="/na-mieru"
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-[15px] font-semibold transition-colors w-fit"
              >
                Projekt na mieru
              </Link>
            </div>
